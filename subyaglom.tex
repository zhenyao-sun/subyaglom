...
\begin{iss}[Open]~
  \begin{itemize}
  \item[ZS:]
I need to introduce the generalized spine decomposition in my paper here. Because the size-biased transform of the Kuznetsov measure will be used in the proof.
  \end{itemize}
\end{iss}
